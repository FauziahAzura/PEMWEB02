...
<body>
    ...
    <div class="hero">
        <div>
            ...
            <a href="<?php echo e(route('pasien.index')); ?>" class="btn btn-light btn-start">Mulai Akses Data</a>
        </div>

        <?php if(auth()->guard()->check()): ?>
        <div class="mt-4">
            <p class="fw-bold fs-4">Anda sudah login sebagai <?php echo e(Auth::user()->name); ?></p>
        </div>
        <?php endif; ?>
    </div>
